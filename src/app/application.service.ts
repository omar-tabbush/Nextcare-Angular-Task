  ...
  searchClaims(
    ...
    return this.http.get(
      'https://api.backendless.com/115C1BE2-C249-0CB1-FF9D-0979E5366300/BE7A57A5-8B95-4D32-B2FD-4C5DA14122C8/data/claims?where=' +
        `(admission_date >= '${startDate}' AND admission_date <=  '${endDate}' OR '${startDate}' = '' OR '${endDate}' = '') AND (insured_card_number LIKE '%25${insured_card_number}%25' OR '${insured_card_number}' = '') AND (hospital LIKE '%25${hospital}%25' OR '${hospital}' = '')`
